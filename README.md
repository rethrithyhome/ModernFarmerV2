...
3. **Token នៅប្រើបានក្រោយប្តូរពាក្យសម្ងាត់** — JWT `iat` រាប់ជា**វិនាទី** ដូច្នេះការប្តូរក្នុងវិនាទីតែមួយនឹងការចេញ token មិនត្រូវបានចាប់។ ដោះស្រាយដោយបន្ថែមពេលវេលាជាមិល្លីវិនាទីក្នុង token
4. **របាយការណ៍លក់រាប់វិក្កយបត្រលុបចោល** — `LEFT JOIN ... AND status='confirmed'` នៅតែរាប់ជួរ។ បង្ហាញ ១១៨ បាវ ខណៈពិតជា ៨។ កែដោយប្រើ `FILTER (WHERE ...)`
