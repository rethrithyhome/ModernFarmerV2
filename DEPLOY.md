...
4. ធ្វើដដែលសម្រាប់ `db/migration_003_offline.sql`
...
រត់តាមលំដាប់ខាងលើ (schema → 002 → 003 → seed) ព្រោះនីមួយៗពឹងផ្អែកលើមុន។ បើឃើញ "Success. No rows returned" គឺត្រឹមត្រូវហើយ។
